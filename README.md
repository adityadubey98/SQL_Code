...
## Overview
- `Worker`: Stores details about employees, including their names, salaries, joining dates, and departments.
- `Bonus`: Tracks employees' bonuses with amounts and dates.
- `Title`: Maintains job titles assigned to employees and their effective dates.
